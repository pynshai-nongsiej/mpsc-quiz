...
<nav class="mobile-bottom-navbar fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 md:hidden" style="display: none;">
    ...
    <div class="mobile-nav-content flex items-center justify-around px-2 py-2">
        ...
        <!-- Leaderboard -->
        <a href="leaderboard.php" class="mobile-nav-item <?php echo $current_page === 'leaderboard.php' ? 'active' : ''; ?>">
            <svg class="mobile-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path d="M9 19v-6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2z"></path>
                <path d="M19 19v-14a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2z"></path>
                <path d="M15 19v-10a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2z"></path>
            </svg>
        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex-1 py-4">
                <nav class="space-y-1">
                    ...
                    <a href="/leaderboard.php" class="mobile-nav-link flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 p-4">
                ...
                <div class="space-y-2">
                    ...
                    <a href="/leaderboard.php" class="mobile-nav-link flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
